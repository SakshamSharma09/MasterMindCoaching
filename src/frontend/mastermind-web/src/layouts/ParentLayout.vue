<template>
  <div class="min-h-screen bg-[radial-gradient(circle_at_top_left,rgba(217,161,45,0.15),transparent_30%),linear-gradient(135deg,#f7fbff_0%,#fffaf1_100%)]">
    <!-- Sidebar -->
      ...
      <div class="flex flex-col h-full">
        ...
        <div class="flex h-20 items-center justify-center border-b border-slate-100 px-4">
          <div class="flex items-center space-x-2">
            <span class="flex h-11 w-11 items-center justify-center rounded-2xl bg-gradient-to-br from-[#0a1d39] via-[#194f86] to-[#d9a12d] text-white shadow-lg shadow-amber-900/15">
        ...
        <div class="border-t border-gray-200 p-4">
          <div class="flex items-center space-x-3">
            <div class="flex-shrink-0">
              <div class="h-8 w-8 rounded-full bg-gradient-to-br from-[#0a1d39] to-[#d9a12d] flex items-center justify-center">
...
onMounted(() => {
  ...
  notificationTimer = window.setInterval(loadNotifications, 5 * 60 * 1000)
  ...
  ;(window as any).__parentNotificationCleanup = () => {
...
onBeforeUnmount(() => {
  ...
  removeRouteHook?.()
  ;(window as any).__parentNotificationCleanup?.()
  delete (window as any).__parentNotificationCleanup
})
</script>
